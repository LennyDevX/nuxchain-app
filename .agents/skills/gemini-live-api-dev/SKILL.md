...
> [!NOTE]
> The Live API currently **only supports WebSockets**. For WebRTC support or simplified integration, consider using a partner integration like LiveKit, Pipecat, Fishjam, Vision Agents, Voximplant, or Firebase AI SDK.
