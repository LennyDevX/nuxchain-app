 ...
 */
export function isBlockchainFunction(name: string): name is BlockchainFunctionName {
  return blockchainFunctionNames.includes(name as BlockchainFunctionName);
}

/**
 * Get function declaration by name
 */
export function getFunctionDeclaration(name: BlockchainFunctionName) {
  const declarations: Record<BlockchainFunctionName, typeof getPolPriceDeclaration> = {
