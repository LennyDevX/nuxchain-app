...
const knowledgeBase: KnowledgeBaseItem[] = [
  ...
  },
  {
    ...
    commands: ['staking skills', 'skill types', 'stake boost', 'auto compound skill', 'fee reducer', 'lock reducer', 'stake boost I', 'stake boost II', 'stake boost III', 'lock reducer price', 'fee reducer price']
  },
  {
  ...
  },
  {
    ...
    commands: ['skill rarity', 'skill tiers', 'legendary skills', 'epic skills', 'common skills', 'skill power', 'rarity multiplier', 'skill effect']
  },
