    ...
    <div className="space-y-6">
      ...
      <div className="p-6 bg-gradient-to-br from-purple-500/10 to-transparent border border-purple-500/20 rounded-2xl">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="font-black text-white uppercase tracking-wide text-lg">
            How Rewards Work
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="p-3 bg-black/30 rounded-xl text-center">
            ...
            <div className="text-white font-bold text-sm">1. Complete Quests</div>
            <div className="text-gray-500 text-xs">Finish tasks to earn POL</div>
          </div>
          <div className="p-3 bg-black/30 rounded-xl text-center">
            <div className="text-2xl mb-1">💰</div>
            <div className="text-white font-bold text-sm">2. Accumulate</div>
            <div className="text-gray-500 text-xs">Rewards stored in contract</div>
          </div>
          <div className="p-3 bg-black/30 rounded-xl text-center">
            <div className="text-2xl mb-1">🎯</div>
            <div className="text-white font-bold text-sm">3. Claim</div>
            <div className="text-gray-500 text-xs">Withdraw with tiered fee</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 bg-[#1a1a1a]/50 border border-white/10 rounded-xl">
          <h5 className="text-white font-bold text-sm mb-2">Max Reward Limits</h5>
        ...
        <div className="p-4 bg-[#1a1a1a]/50 border border-white/10 rounded-xl">
          <h5 className="text-white font-bold text-sm mb-2">Quest Types</h5>
          <ul className="space-y-1 text-gray-400 text-xs">
            <li className="flex items-center gap-2">
