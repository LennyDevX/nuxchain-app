      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="card-interactive text-center group relative overflow-hidden">
            ...
            <h3 className="text-2xl font-bold text-white mb-6">Nuxchain Protocols</h3>
          ...
          <div className="card-interactive text-center hover:-translate-y-3 group relative overflow-hidden">
            ...
            <h3 className="text-2xl font-bold text-white mb-6">NFTs 2.0</h3>
            <p className="text-white/80 leading-relaxed mb-4">
          ...
          <div className="card-interactive text-center hover:-translate-y-3 group relative overflow-hidden">
            ...
            <h3 className="text-2xl font-bold text-white mb-6">Nux-chain</h3>
            <p className="text-white/80 leading-relaxed mb-4">
          ...
          <div className="card-interactive text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-3 group relative overflow-hidden">
            ...
            <h3 className="text-2xl font-bold text-white mb-6">Nux-AI</h3>
            <p className="text-white/80 leading-relaxed mb-4">
          ...
          <div className="card-interactive text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-3 group relative overflow-hidden">
            ...
            <h3 className="text-2xl font-bold text-white mb-6">Nuxchain Labs</h3>
            <p className="text-white/80 leading-relaxed mb-4">
          ...
          <div className="card-interactive text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-3 group relative overflow-hidden">
            ...
            <h3 className="text-2xl font-bold text-white mb-6">Nux-Vault</h3>
            <p className="text-white/80 leading-relaxed mb-4">
