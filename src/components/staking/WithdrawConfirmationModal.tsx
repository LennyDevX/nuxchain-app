        ...
        >
          ...
          <div className="px-6 py-6 space-y-4">
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-semibold text-white/80 uppercase tracking-wide">Withdrawal Summary</h4>
              
              <div className="bg-slate-800/50 rounded-lg p-4 space-y-2 border border-white/5">
                <div className="flex justify-between items-center">
                  <span className="text-white/60">Your Staked Amount:</span>
                  <span className="text-white font-semibold">{formatPOL(userStaked)} POL</span>
                </div>
                
                <div className="flex justify-between items-center">
                  <span className="text-white/60">Pending Rewards:</span>
                  <span className="text-green-400 font-semibold">+{formatPOL(pendingRewards)} POL</span>
                </div>
                
                <div className="h-px bg-white/10 my-2"></div>
                
                <div className="flex justify-between items-center">
                  <span className="text-white font-semibold">Total to Withdraw:</span>
                  <span className="text-xl text-cyan-400 font-bold">{formatPOL(totalToWithdraw)} POL</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-semibold text-white/80 uppercase tracking-wide">Contract Balance Check</h4>
              ...
              <div className={`rounded-lg p-4 border-2 ${
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="text-white/80">Available in Contract:</span>
                    ...
                    {!hasSufficientBalance && (
                      <>
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-red-300">Deficit:</span>
                          <span className="text-red-400 font-semibold">-{formatPOL(balanceDeficit)} POL</span>
                        </div>
                        ...
                        <div className="mt-3 pt-3 border-t border-red-500/20">
                          ...
                          <p className="text-xs text-yellow-300 mt-2 leading-relaxed">
          ...
          <div className="px-6 py-4 bg-slate-900/50 border-t border-white/10 flex gap-3">
            <button
              ...
              className="flex-1 px-4 py-3 bg-slate-700 hover:bg-slate-600 text-white font-semibold rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Cancel
            </button>
