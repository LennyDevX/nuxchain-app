...
/**
 * @title ISmartStakingSkills
 * @notice Interface for NFT skill management in the SmartStaking system
 * @dev This module handles skill activation/deactivation, rarity tracking, and boost calculations
 */
interface ISmartStakingSkills {
    ...
    * @param effectValue The effect value in basis points (overrides defaults when > 0)
     ...
     */
    function updateSkillBoost(IStakingIntegration.PowerType skillType, uint16 newBoost) external;
    ...
    * @param skillType The skill type defined in IStakingIntegration
     ...
     */
    function getSkillBoost(IStakingIntegration.PowerType skillType) external view returns (uint16 boost);
