...
const RoadmapPage: React.FC = () => {
  ...
  return (
    <GlobalBackground>
      ...
      {/* Main Content */}
      <div className={`max-w-7xl mx-auto ${isMobile ? 'px-4 py-8' : 'px-4 sm:px-6 lg:px-8 py-16'
        }`}>
        <div className={isMobile ? 'space-y-12' : 'space-y-20'}>
          ...
          {/* CTA Section */}
          <section>
            <div className={` text-center relative overflow-hidden ${isMobile ? 'p-6' : 'p-12'
              }`}>
              <div className="relative z-10">
                ...
                <p className={`text-slate-400 max-w-2xl mx-auto ${isMobile ? 'text-sm mb-6' : 'text-lg mb-8'
                  }`}>
